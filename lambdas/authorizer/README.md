...
This is a sample template for api-authorization-roles - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name api-authorization-roles \
...
```bash
sam logs -n HelloWorldFunction --stack-name api-authorization-roles --tail
```
...
```bash
aws cloudformation delete-stack --stack-name api-authorization-roles
```
