...
my-application$ sam local invoke getAllStocksFunction --event events/event-get-all-items.json
```
...
```bash
aws cloudformation delete-stack --stack-name sam-app-zip
```
